# 写在前面
![GitHub stars](https://img.shields.io/github/stars/Sfssup/mihomo-set?style=flat-square) ![Profile Views](https://komarev.com/ghpvc/?username=Sfssup&color=blue) [![Telegram](https://img.shields.io/badge/Telegram-Channel-2CA5E0?style=flat-square&logo=telegram&logoColor=white)](https://t.me/ksc666)
...
- [Clash Experimenta](https://github.com/ClashDotNetFramework/experimental-clash)
- [Clash RS](https://github.com/Watfaq/clash-rs)
- [Mihomo](https://github.com/MetaCubeX/mihomo)
  - [Mihomo 文档](https://wiki.metacubex.one/config/general/)
- [Mihomo Smart](https://github.com/vernesong/mihomo)

# 路由规则
- [Domain list](https://github.com/v2fly/domain-list-community)
  - 社区管理的Geosite域名列表
- [Rules And Scripts](https://github.com/blackmatrix7/ios_rule_script)
  - 各平台的分流规则、复写规则及自动化脚本。
- [anti-ip-attribution](https://github.com/lwd-temp/anti-ip-attribution)
...
>>- [Flux](https://github.com/Chth1z/Flux)

>## iOS
>- [ClashMi](https://github.com/KaringX/clashmi)
>- [Clash Lite](https://apps.apple.com/app/id6761357475)（不开源）
>- [LinkClashX](https://apps.apple.com/app/id6757075299)（不开源）
>- [ConnectNow](https://apps.apple.com/app/id6749354119)（不开源）
>- [Everywhere](https://github.com/NodePassProject/Everywhere)
>- [Nextin](https://apps.apple.com/app/id6754002454)（不开源）
>- [Rabbit Hole](https://apps.apple.com/us/app/rabbithole-vpn-client/id6683309629)（不开源）

>## Windows
>- [Clash For Windows](https://github.com/Fndroid/clash_for_windows_pkg)
>- [Clash Chinese Patch](https://github.com/BoyceLig/Clash_Chinese_Patch)（↑汉化补丁）
>- [Clash Mini](https://github.com/MetaCubeX/Clash.Mini)
>- [Clash Warden](https://github.com/dream7180/ClashWarden)
...
>- [SingBoxClient](https://github.com/daodao97/SingBoxClient)
...
>- [FullCombo Shark](https://github.com/fcshark-org/openwrt-fchomo)
>- [openwrt-nekobox](https://github.com/Thaolga/openwrt-nekobox)
>- [ShellCrash](https://github.com/juewuy/ShellCrash)
...
- [Mihomo 配置文件](https://github.com/Sfssup/MihomoConfigFile/blob/main/config/config.yaml)
  - 该配置会不断完善，有问题可发[Issues](https://github.com/Sfssup/mihomo-set/issues)
...
- [淘气兔](https://vip.taoqitu.pro/index.html?register=rNh8X1zf)
